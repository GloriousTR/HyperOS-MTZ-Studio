...
object ThemeManagerContract {
    ...
    fun behavior(versionName: String?): ThemeManagerBehavior = when (canonicalVersion(versionName)) {
        "2.15.5.46" -> ThemeManagerBehavior.LOCAL_THEME_IMPORT
...
data class InstalledThemeManager(
    ...
    val isRecommended: Boolean
        get() = installed && ThemeManagerContract.canonicalVersion(versionName) == ThemeManagerContract.RECOMMENDED_VERSION
}
