...
<p align="center">
  <a href="https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/tag/v4.2.3"><strong>v4.2.3 APK indir</strong></a>
  · <a href="docs/release-notes-v4.2.3.md">Sürüm notları</a>
...
1. [v4.2.3 Release](https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/tag/v4.2.3) sayfasından `MTZ_Studio_v4.2.3.apk` dosyasını indirin.
