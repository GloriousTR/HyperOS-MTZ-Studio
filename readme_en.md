...
<p align="center">
  <a href="https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/tag/v4.0.2"><strong>Download v4.0.2 APK</strong></a>
  · <a href="docs/release-notes-v4.0.2.md">Release notes</a>
...
- **MTZ Import:** validates MTZ packages, adds them to the private library and produces preview data. Choose one file or batch-import up to five files.
...
- [Xiaomi Themes 3.0.5.6-global APK](https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/download/v4.0.2/Xiaomi_Themes_3.0.5.6-global.apk)
- [SHA-256 checksum](https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/download/v4.0.2/Xiaomi_Themes_3.0.5.6-global.apk.sha256)
...
1. Download `MTZ_Studio_v4.0.2.apk` from the [v4.0.2 release](https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/tag/v4.0.2).
