...
<p align="center">
  <a href="https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/tag/v4.2.2"><strong>Download v4.2.2 APK</strong></a>
  · <a href="docs/release-notes-v4.2.2.md">Release notes</a>
...
1. Download `MTZ_Studio_v4.2.2.apk` from the [v4.2.2 release](https://github.com/GloriousTR/HyperOS-MTZ-Studio/releases/tag/v4.2.2).
